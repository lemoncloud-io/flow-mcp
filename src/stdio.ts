...
if (process.argv.includes('--help') || process.argv.includes('-h')) {
    process.stdout.write(
        [
            ...
            '  FLOW_API_KEY      Eureka API key. Optional — leave unset and use the auth tool',
            '                    to log in via browser (mints and stores a key).',
            '  FLOW_API_URL      API base URL (default: https://api.eureka.codes/flw-v1)',
            '  FLOW_WEB_URL      Web console base URL for flow links (default: https://flow.eureka.codes)',
